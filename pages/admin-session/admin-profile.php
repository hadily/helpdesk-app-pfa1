...
<body class="g-sidenav-show bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link " href="../admin-session/admin-home.php">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../admin-session/admin-profile.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="row gx-4">
          <div class="col-auto">
            ...
            <div class="avatar avatar-xl position-relative">
              ...
              ?> 
                <img src="../../assets/img/uploads/<?php echo $row['image']; ?>" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
            <!-- fin div image -->
          </div>
        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-header pb-0">
              ...
              $url = '../includes/upload.php?user='.urlencode($row['username']);
              ...
              ?>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <input style="max-width:50%; margin-left:40%;" class="form-control" type="file" name="uploadfile" value="" />
                  <button type="submit" name="upload" style="margin-bottom:0; max-height:150px;" class="btn btn-primary btn-sm ms-auto">Upload</button>
                </div>
              </form>
            </div>
            <div class="card-body">
